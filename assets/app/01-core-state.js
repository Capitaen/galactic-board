...
let saveLocalStateTimer = null;
let saveLocalStatePending = false;
let lastLocalCampaignSnapshot = '';
...
const fleetStackPanel = document.getElementById('fleetStackPanel');
...
const fleetClusterElements = new Map();
const fleetRenderPositions = new Map();
const fleetClusterMembership = new Map();
const fleetClusterGroups = new Map();
let routeCache = [];
...
const SETTINGS_SHOW_ALL_PLANETS_KEY = 'gcb_ui_v1.settings.showAllPlanets';
